  ...
  return (
    <div className="page-with-nav">
      ...
      <main className="page-content">
        <h2>About World of Maps – Daily Geography & Data Guessing Game</h2>
        <p>
        ...
        <h3>Our Mission: Elevate Geography & Data Literacy</h3>
        <p>
        ...
        <h3>Authentic Open Data Sources</h3>
